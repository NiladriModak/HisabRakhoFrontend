import {
  ...
  ADD_SUCCESS,
  ALL_CATAGORY_FAIL,
  ALL_CATAGORY_REQUEST,
  ALL_CATAGORY_SUCCESS,
  ALL_PRODUCT_FAIL,
  ALL_PRODUCT_REQUEST,
  ALL_PRODUCT_SUCCESS,
  ALL_VENDOR_FAIL,
  ...
  EMPTY_SUCCESS,
  LARGEST_SOLD_FAIL,
  LARGEST_SOLD_REQUEST,
  LARGEST_SOLD_SUCCESS,
  SINGLE_PRODUCT_FAIL,
  SINGLE_PRODUCT_REQUEST,
  SINGLE_PRODUCT_SUCCESS,
  SINGLE_VENDOR_FAIL,
  SINGLE_VENDOR_REQUEST,
  SINGLE_VENDOR_SUCCESS,
...
export const UpdatePayments = (id, GivenData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `/api/allVendor/${id}/updatePayment`,
      GivenData,
      config
    );
    dispatch({ type: SINGLE_VENDOR_SUCCESS, payload: data.vendor });
