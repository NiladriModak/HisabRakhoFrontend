            ...
            <div className="Box">
              ...
              <div className="Options">
                <div className="AddProduct">
                  <button variant="outlined" onClick={handleClickOpenAddDialog}>
                    Add to stock
                  </button>
                ...
                <div className="Record">
                  <button
                    variant="outlined"
                    onClick={handleClickOpenRecordDialog}
                  >
                    Record
                  </button>
                  <Dialog
                  ...
                  >
                    <DialogTitle>
                      Total Record Of Adding and Removing Quantity
                    </DialogTitle>
                    <DialogContent>
                      <DialogContentText>
                        {product.product &&
                          product.product.Record.map((item) => (
                            <h3>
                ...
                <div className="Edit Prouduct">
                  ...
                  <Dialog open={editOpen} onClose={handleCloseEdit}>
                    ...
                    <DialogContent>
                      <DialogContentText>Update Product Name</DialogContentText>
                      <input
                        className="DialogInputFeild"
                        autoFocus
                        margin="dense"
